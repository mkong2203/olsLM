...
[![Codecov test coverage](https://codecov.io/gh/mkong2203/olsLM/branch/main/graph/badge.svg)](https://app.codecov.io/gh/mkong2203/olsLM)
...
```{r, echo = TRUE, results = "hide", fig.show = "hide", eval = FALSE}
library(olsLM)
...
When `x` is a numeric matrix, `olsLM()` automatically adds an intercept column, similar to `lm()`.
